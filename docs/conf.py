...
project = "WireGuard gateway charm"
...
ogp_site_url = f"https://canonical.com/juju/docs/wireguard-gateway-charm/{version}/"
...
html_context = {
    ...
    "product_page": "charmhub.io/wireguard-gateway",
    ...
    "github_url": "https://github.com/canonical/wireguard-gateway-operator",
...
#
html_theme_options = {
"source_edit_link": "https://github.com/canonical/wireguard-gateway-operator",
}
...
slug = 'juju/docs/wireguard-gateway-charm'
...
html_baseurl = f"https://canonical.com/juju/docs/wireguard-gateway-charm/{version}/"
