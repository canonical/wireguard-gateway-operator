.. meta::
   :description: Familiarize yourself with contributing to the WireGuard gateway charm documentation.
...
`source code on GitHub <https://github.com/canonical/wireguard-gateway-operator>`_.
You may open a pull request with your documentation changes, or you can
`file a bug <https://github.com/canonical/wireguard-gateway-operator/issues>`_
