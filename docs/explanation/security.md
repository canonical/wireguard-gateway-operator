...
The WireGuard gateway charm leverages the asymmetric cryptographic properties of the WireGuard protocol to ensure that only public keys are exchanged between charms, and private keys never leave the machine.
